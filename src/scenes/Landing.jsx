      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            Having just completed a degree in computer science, I'm passionate
            about creating scalable online applications using the full stack.
            Seeking an opportunity as a web developer where I can grow with the
            organisation and enhance my understanding of web design and
            development.
          </p>
        </motion.div>
